...
const BenefitsWithGraphic = () => {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-[#baf742]/5 via-white to-[#baf742]/5 overflow-hidden flex items-center justify-center">
                ...
                <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-4 border border-green-100 shadow-2xl group-hover:shadow-3xl transition-all duration-500">
                  <div className="relative overflow-hidden rounded-2xl">
                    <img 
                      ...
                      className="w-full h-auto shadow-lg group-hover:scale-105 transition-transform duration-500"
                      style={{ 
