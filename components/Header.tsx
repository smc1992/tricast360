  ...
  return (
    <>
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 font-inter ${ 
        isScrolled 
          ? 'bg-white/95 backdrop-blur-md border-b border-[#39F2AE]/30 shadow-sm' 
          : 'bg-white/90 backdrop-blur-sm border-b border-transparent'
      }`}>
        <div className="w-full px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-2 group">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-[#39F2AE] to-[#2dd89a] rounded-xl flex items-center justify-center group-hover:scale-110 transition-all duration-300 shadow-lg">
                <i className="ri-tree-line text-white text-lg sm:text-xl group-hover:rotate-12 transition-transform duration-300"></i>
              </div>
              <span className="text-lg sm:text-xl font-semibold text-gray-800 group-hover:text-[#39F2AE] transition-colors duration-300">
                Tricast360
              </span>
              {/* Umwelt-Badge */}
              <div className="hidden sm:flex items-center gap-1 bg-[#39F2AE]/10 text-[#39F2AE] px-2 py-1 rounded-full text-xs font-medium border border-[#39F2AE]/20">
                <div className="w-1.5 h-1.5 bg-[#39F2AE] rounded-full animate-pulse"></div>
                Nachhaltig
              </div>
            </Link>

            <nav className="hidden lg:flex items-center gap-6 xl:gap-8">
              <Link href="/#problem" className="relative text-gray-600 hover:text-[#39F2AE] transition-colors duration-200 cursor-pointer group text-sm xl:text-base">
                Das Problem
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#39F2AE] group-hover:w-full transition-all duration-300"></span>
              </Link>
              <Link href="/#funktionsweise" className="relative text-gray-600 hover:text-[#39F2AE] transition-colors duration-200 cursor-pointer group text-sm xl:text-base">
                Funktionsweise
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#39F2AE] group-hover:w-full transition-all duration-300"></span>
              </Link>
              <Link href="/#vorteile" className="relative text-gray-600 hover:text-[#39F2AE] transition-colors duration-200 cursor-pointer group text-sm xl:text-base">
                Umweltvorteile
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#39F2AE] group-hover:w-full transition-all duration-300"></span>
              </Link>
              <Link href="/ueber-uns" className="relative text-gray-600 hover:text-[#39F2AE] transition-colors duration-200 cursor-pointer group text-sm xl:text-base">
                Unser Team
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#39F2AE] group-hover:w-full transition-all duration-300"></span>
              </Link>
              <Link href="/kontakt" className="relative text-gray-600 hover:text-[#39F2AE] transition-colors duration-200 cursor-pointer group text-sm xl:text-base">
                Kontakt
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#39F2AE] group-hover:w-full transition-all duration-300"></span>
              </Link>
            </nav>
            ...
            <div className="hidden lg:flex items-center gap-3 xl:gap-4">
              <Link href="/system" className="text-gray-600 hover:text-[#39F2AE] transition-colors duration-200 whitespace-nowrap cursor-pointer flex items-center gap-2 text-sm xl:text-base">
              ...
              <button 
                ...
                className="btn-primary bg-gradient-to-r from-[#39F2AE] to-[#2dd89a] text-[#2b3138] px-4 xl:px-6 py-2 xl:py-3 rounded-xl xl:rounded-2xl font-semibold hover:shadow-lg transition-all duration-300 whitespace-nowrap cursor-pointer flex items-center gap-2 text-sm xl:text-base relative overflow-hidden group"
              >
            ...
            <div className="p-6 pt-20 bg-white h-screen min-h-screen">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <button 
                  ...
                  className="w-full bg-gradient-to-r from-[#39F2AE] to-[#2dd89a] text-[#2b3138] px-6 py-4 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2"
                >
                  <i className="ri-file-text-line text-lg"></i>
                  Projekt anfragen
                </button>
